...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
			...
			case 'israel':
				{
						defaultCamZoom = 0.9;
						curStage = 'israel';
						var bg:FlxSprite = new FlxSprite(-100, 0).loadGraphic(Paths.image('carbombstage'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Pain" : "Easy") + (Main.watermarks ? " - KE " + MainMenuState.kadeEngineVer : ""), 16);
	...
	*/
	...
	function flashbang() // i stole this from bob mod cause even though i couldve made this from scratch its 12:05 am
		{
